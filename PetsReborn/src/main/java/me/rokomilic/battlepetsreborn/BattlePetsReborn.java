...
import me.rokomilic.battlepetsreborn.events.ArmorStandEvent;
import me.rokomilic.battlepetsreborn.events.EntityEvents;
...
public class BattlePetsReborn extends JavaPlugin implements Listener {
    ...
    public static ItemStack createEgg(String type, String args[]) {
        ...
        full_type+=type;
        MobStats statsai = BattlePetsReborn.statsai.get(type.toLowerCase());
        ...
        return item;
    		...
    		if (tries<5) {
    			tries++;
    			return BattlePetsReborn.createEgg(type, args);
    		} else {
    		tries=0;
    		e.printStackTrace();
    		}
    ...
    public void reload() {
        ...
        statsai.clear();
        ((BattlePetsReborn) BattlePetsReborn.plugin).allowed.clear();
        Shop.menus.clear();
        shop.createshop();
