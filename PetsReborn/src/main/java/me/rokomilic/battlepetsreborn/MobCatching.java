...
public class MobCatching implements Listener {
    ...
    public MobCatching(BattlePetsReborn plugin) {
        this.plugin = plugin;
    ...
    public void hit(EntityDamageByEntityEvent event) {
        ...
        if (!BattlePetsReborn.AllWorlds && !BattlePetsReborn.worlds.contains(player.getWorld().getName())) {
        ...
        //	typeconf="block";
        if (!BattlePetsReborn.statsai.containsKey(typeconf)) {
